...
const Hero = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-items-center bg-gradient-to-b from-emerald-200 to-white w-full h-full py-20 lg:pt-10">
      <div className="travigo-container grid items-center justify-items-center mt-7">
        <div className="grid items-center justify-items-center">
          ...
          <p className="text-xl sm:text-sm text-center my-4 md:my-2">{text}</p>
