...
const Hero = () => {
  ...
  return (
    <div className=" flex flex-col items-center justify-items-center bg-gradient-to-b from-emerald-200 to-white w-full h-full">
      <div className="travigo-container grid items-center justify-items-center mt-7">
        ...
        <div className=" grid items-center justify-items-center mt-4 mb-5">
          <img
            ...
            className=" w-full h-[75vh] lg:h-[63vh] md:[55vh] sm:h-[35vh] object-fill img-emerald-shadow"
          />
        </div>
      </div>
    </div>
